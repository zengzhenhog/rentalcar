...
const (
	...
	TripService_GetTipps_FullMethodName   = "/rental.v1.TripService/GetTipps"
...
type TripServiceClient interface {
	...
	GetTipps(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripsResponse, error)
...
func (c *tripServiceClient) GetTipps(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripsResponse, error) {
	out := new(GetTripsResponse)
	err := c.cc.Invoke(ctx, TripService_GetTipps_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TripServiceServer interface {
	...
	GetTipps(context.Context, *GetTripsRequest) (*GetTripsResponse, error)
...
func (UnimplementedTripServiceServer) GetTipps(context.Context, *GetTripsRequest) (*GetTripsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTipps not implemented")
}
...
func _TripService_GetTipps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTripsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TripServiceServer).GetTipps(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TripService_GetTipps_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TripServiceServer).GetTipps(ctx, req.(*GetTripsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TripService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTipps",
			Handler:    _TripService_GetTipps_Handler,
		},
		{
