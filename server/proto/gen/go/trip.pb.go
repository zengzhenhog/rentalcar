...
type Trip struct {
	...
	PathLocations []*Location `protobuf:"bytes,7,rep,name=path_locations,json=pathLocations,proto3" json:"path_locations,omitempty"` // 字段以s结尾 repeated-slice
...
func (x *GetTripRespons) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTripRespons) ProtoMessage() {}

func (x *GetTripRespons) ProtoReflect() protoreflect.Message {
	mi := &file_trip_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTripRespons.ProtoReflect.Descriptor instead.
func (*GetTripRespons) Descriptor() ([]byte, []int) {
	return file_trip_proto_rawDescGZIP(), []int{3}
}

func (x *GetTripRespons) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetTripRespons) GetTrip() *Trip {
	if x != nil {
		return x.Trip
	}
	return nil
...
var file_trip_proto_rawDesc = []byte{
	...
	0x43, 0x65, 0x6e, 0x74, 0x12, 0x2a, 0x0a, 0x07, 0x65, 0x6e, 0x64, 0x5f, 0x70, 0x6f, 0x73, 0x18,
	...
	0x43, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x21, 0x0a, 0x04, 0x74, 0x72, 0x69, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0d, 0x2e, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x54, 0x72, 0x69, 0x70, 0x52, 0x04,
	...
	0x10, 0x04, 0x32, 0x4a, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x3b, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x12, 0x17, 0x2e, 0x63,
	0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e,
	0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x42, 0x1d,
	0x5a, 0x1b, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
...
var file_trip_proto_goTypes = []interface{}{
	...
	(*GetTripRespons)(nil), // 4: coolcar.GetTripRespons
}
var file_trip_proto_depIdxs = []int32{
	...
	2, // 4: coolcar.GetTripRespons.trip:type_name -> coolcar.Trip
	3, // 5: coolcar.TripService.GetTrip:input_type -> coolcar.GetTripRequest
	4, // 6: coolcar.TripService.GetTrip:output_type -> coolcar.GetTripRespons
